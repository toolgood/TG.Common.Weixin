...
namespace TG.Common.Weixin.Qy.Datas
{
    ...
    /// 异步任务Id返回结果
    /// </summary>
    public class AsynchronousJobId : JsonResult
    {
        /// <summary>
        /// 异步任务id，最大长度为64字符
        /// </summary>
    ...
    public class BaseAsynchronousResult : JsonResult
    {
        /// <summary>
    ...
    public class AsynchronousInviteUserItem : JsonResult
    {
        /// <summary>
        /// 成员UserID。对应管理端的帐号
        /// </summary>
    ...
    public class AsynchronousReplaceUserItem : JsonResult
    {
        /// <summary>
        /// 成员UserID。对应管理端的帐号
        /// </summary>
    ...
    public class AsynchronousReplacePartyItem : JsonResult
    {
        /// <summary>
        /// 部门ID
        /// </summary>
