...
{
    public class MenuApi : MpApi
    {
        public MenuApi(WxMpApi api) : base(api) { }
        /// <summary>
        /// 创建菜单
        /// </summary>
        ...
        public JsonResult CreateMenu(ButtonGroup buttonData, int timeOut = Config.TIME_OUT)
        {
            ...
            return Post<JsonResult>(url, buttonData, timeOut);
        }
        ...
        public GetMenuResult GetMenuFromJson(string jsonString)
        {
            ...
            try
            {
                ...
                {
                    //菜单不存在
                    throw new Exception(fullResult["errmsg"] as string);
                }
            }
            catch (Exception ex)
            {
