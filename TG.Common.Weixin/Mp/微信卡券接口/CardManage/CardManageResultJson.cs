...
namespace TG.Common.Weixin.Mp.Datas
{
    ...
    /// 删除卡券返回结果
    /// </summary>
    public class CardDeleteResultJson : JsonResult
    {
    }
    ...
    /// 查询code返回结果
    /// </summary>
    public class CardGetResultJson : JsonResult
    {
        /// <summary>
        /// 用户openid
        /// </summary>
    ...
    /// 批量查询卡列表返回结果
    /// </summary>
    public class CardBatchGetResultJson : JsonResult
    {
    ...
    /// 查询卡券详情返回结果
    /// </summary>
    public class CardDetailGetResultJson : JsonResult
    {
    ...
    /// 会员卡交易返回结果
    /// </summary>
    public class MemberCardDeal : JsonResult
    {
        /// <summary>
        /// 当前用户积分总额
        /// </summary>
    ...
    /// 获取用户已领取卡券返回结果
    /// </summary>
    public class GetCardListResult : JsonResult
    {
        /// <summary>
        /// 卡券列表
        /// </summary>
    ...
    /// 更新会员信息返回结果
    /// </summary>
    public class UpdateUserResult : JsonResult
    {
        /// <summary>
        /// 当前用户积分总额。
        /// </summary>
    ...
    /// 图文消息群发卡券返回结果
    /// </summary>
    public class GetHtmlResult : JsonResult
    {
        /// <summary>
